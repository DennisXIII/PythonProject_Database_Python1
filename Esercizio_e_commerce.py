...
def menu_admin():
    ...
    print("5) Visualizza storico di tutti gli utenti")
    print("6) Logout")
...
def registra_utente_admin():
    nome_utente = input("Inserisci nome utente: ")
    password = input("Inserisci password: ")

    q = "insert into utenti(username, pswd, ruolo) VALUES (%s, %s, %s);"
    v = (nome_utente, password, "admin")
...
def visualizza_prodotti_disponibili(id_prodotto):
    ...
    print(f"I prodotti sono è: {ris[0]['nome']}")
                ...
                if risultato['ruolo'] == "admin":
                    ...
                    while True:
                        ...
                        if scelta_cliente == 1:
                            ...
                            visualizza_prodotti_disponibili(id_prodotto)
